...
token = "vk1.a.M7yA855RuIJg3N0xptGJLiJETzMbrXh2aMZZ2kpH6z958HDsQykjgJPgvLUeMyBe8g-Ah01ZylQN8s__SdRM_zsO8Q8x4zgTbhH0PK8pOCTlcuVoUBTRdUEHssfaUWZT_aH7ZObc3DE5TeMDqc6Q5rTL0QN2TUHVK51fHRM_ESkah_O3wRveFzM22cJFRdQP00FLhwL6BQdNiG7Qt2NDQQ"
...
#Функции для чтения и писания джсона
...
def test():
    while True:
        try:
            send_photo('photo' + str(random.randint(300000000, 606619167)) + '_4572' + str(random.randint(10000, 88246)))
        except Exception:
            pass
